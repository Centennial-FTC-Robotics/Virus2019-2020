...
public class PIDControllers {
    ...
    public static PIDController xController = new PIDController(.07f,.05f ,0.001f,0.05f);
    public static PIDController yController = new PIDController(.07f,.05f ,0.001f,0.05f);
    public static PIDController headingController = new PIDController(-.05f, -.005f,-.001f, .1f);
    //slides PID
    //
}

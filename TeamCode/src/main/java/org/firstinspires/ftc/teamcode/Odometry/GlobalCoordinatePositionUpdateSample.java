...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    String verticalLeftEncoderName = "lFront", verticalRightEncoderName = "rFront", horizontalEncoderName = "lBack";
...
//        globalPositionUpdate.reverseNormalEncoder();
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("lEncoder", verticalLeft.getCurrentPosition());
            telemetry.addData("rEncoder", verticalRight.getCurrentPosition());
            telemetry.addData("bEncoder", horizontal.getCurrentPosition());

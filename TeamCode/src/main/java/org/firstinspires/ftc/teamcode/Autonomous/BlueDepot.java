...
//        telemetry.update();
        ...
        //go to foundation
        while(Agobot.drivetrain.goToPosition(new Vector2D(-39, 48), 180, 0.8, 1.5, 3) && opModeIsActive() && (Agobot.clock.milliseconds() < (Agobot.autoStarted + 29000))){

        }

        //get closer to foundation
        while(Agobot.drivetrain.goToPosition(new Vector2D(-30, 48), 180, 0.6, 1.5) && opModeIsActive() && (Agobot.clock.milliseconds() < (Agobot.autoStarted + 20000)) && (Agobot.clock.milliseconds() < (Agobot.autoStarted + 29000))){
            // place skystone
            Agobot.arm.armFlipOut(true);
        }
        ...
        while(Agobot.drivetrain.goToPosition(new Vector2D(-28, 40), 180, 0.6,1.5) && opModeIsActive() && (Agobot.clock.milliseconds() < (Agobot.autoStarted + 29000))) {

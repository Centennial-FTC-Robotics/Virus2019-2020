...
//        }
        ...
        while(Agobot.drivetrain.goToPosition(new Vector2D(-24, yOffset), 270, 0.6)){
...
//        telemetry.update();
        ...
        while(Agobot.drivetrain.goToPosition(new Vector2D(-30, 40), 180, 0.6,1.5)){
        ...
        while(Agobot.drivetrain.goToPosition(new Vector2D(-58, 0), 270, 0.6)){

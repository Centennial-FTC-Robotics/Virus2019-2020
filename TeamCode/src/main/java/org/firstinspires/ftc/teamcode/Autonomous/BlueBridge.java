...
public class BlueBridge extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (Agobot.clock.milliseconds() < (startVision + 1000) && opModeIsActive()) {} // make the robot wait for one second before reading the stones to ensure stable position
